...
import com.hyjf.am.user.response.SmsCodeResponse;
...
public class AmUserClientImpl implements AmUserClient {
	...
	public UserVO findUserByMobile(String mobile) {
		...
		response = restTemplate
				.getForEntity("http://AM-USER/am-user/user/findUserByMobile/" + mobile, UserResponse.class).getBody();
		if (response != null) {
	...
	public int updateCheckMobileCode(String mobile, String verificationCode, String verificationType, String platform,
		...
		restTemplate.postForEntity("http://AM-USER/am-user/user/updateCheckMobileCode/", request, SmsCodeResponse.class)
				.getBody();
		return 1;
	}
