 ...
 * @version 1.0.0
 */
public class CustomConstants implements MessageConstants {
	...
	/*
	 * public static final String FTP_HOST_NAME = "sftp.credit2go.cn"; public
	 * static final String FTP_HOST_USERNAME = "huiyingjinfu"; public static
	 * final String FTP_HOST_PASSWORD = "GebH3ptTpcO"; public static final
	 * String FTP_HOST_DOWNLOADPATH = "/C2P/"; public static final Integer
	 * FTP_HOST_PORT = 5132;
	 *//** 本地存储路径 */
	/*
	 * public static final String DOWNLOADPATH = "D:/test";
	 *//** 文件下载名称+日期 *//*
						 * public static final String ALEVEFILENAME =
						 * "3005-ALEVE0082-"; public static final String
						 * EVEFILENAME = "3005-EVE0082-";
						 */
