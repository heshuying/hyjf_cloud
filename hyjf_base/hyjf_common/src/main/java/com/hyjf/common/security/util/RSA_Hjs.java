...
public class RSA_Hjs {
     ...
     * 汇晶社RSA加密私钥
     */
    private static  String PRIVATEKEY_HJS         = "privatekey.hjs";
    /**
     * 汇晶社RSA加密公钥
     */
    private static  String PUBLICKEY_HJS         = "publickey.hjs";
     ...
     *
     */
    public static String decrypt(String str, String charset,String PUBLICKEY_HJSKey) throws Exception {
        ...
        //公钥解密
        String str1 = new String(RSA_Hjs.decryptByPublicKey(Base64.decodeBase64(str), PUBLICKEY_HJSKey),"utf-8");
        return str1;
     ...
     *
     */
    public static String encode(String str,String PRIVATEKEY_HJSkey) throws Exception {
            if (StringUtils.isEmpty(str)) {
                return null;
            }
          //私钥加密
            String s = Base64.encodeBase64String(RSA_Hjs.encryptByPrivateKey(str.getBytes(), PRIVATEKEY_HJSkey));
            return s;
