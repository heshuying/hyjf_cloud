...
//	ERR_NO_PERMISSION("2","无权限"),
	...
	ERR_AMT_TENDER_MAX_INVESTMENT("EAM000215","项目最大投资金额为{0}元"),
	...
	ERR_AMT_TENDER_SUCCESS("EAM000000","投资成功"),
	...
	STATUS_EV000007("EV000007","达到标的设置类型及以上才可以投资此项目"),
	//----------上传用户头像错误信息-------------
	...
	ERR_AMT_TENDER_MONEY_INCREMENTING("EAM000216","投资递增金额须为{0}元的整数倍"),
