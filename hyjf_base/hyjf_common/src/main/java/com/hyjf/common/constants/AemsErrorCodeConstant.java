...
public class AemsErrorCodeConstant implements MessageConstants, PropertiesConstants {
    ...
    // 用户重复开户
    public static final String STATUS_CE000016 = "CE000016";
    // 系统异常
    ...
    // 大额提现时,银行联行号不能为空
    public static final String STATUS_NC000012 = "NC000012";
    /********************免密提现相关    end***********************/
     ...
     * 查询类型不能为空
     */
    public static final String STATUS_HK000004 = "STATUS_HK000004";

    /**
     * 标的号对应的资产推送信息不存在
     */
    public static final String STATUS_HK000005 = "STATUS_HK000005";
