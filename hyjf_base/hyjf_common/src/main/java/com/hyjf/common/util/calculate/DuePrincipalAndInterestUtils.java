...
public class DuePrincipalAndInterestUtils {
	...
	/**
	 * 到期还本还息（按月计息） 应还利息 公式：应还利息=出借本金*年化收益÷12*融资月数
	 *
	 * @param invest
	 *            总借款额（贷款本金）
	 * @param yearRate
	...
	/**
	 * 到期还本还息（按月计息） 应还本息 公式：应还本息=本金+应还总利息=出借本金*【1+（年化收益÷12*融资月数）】；
	 *
	 * @param invest
	 *            总借款额（贷款本金）
	 * @param yearRate
	...
	/**
	 * 到期还本还息（按天计息） 应还利息 公式：应还利息=出借本金*年化收益÷360*融资天数
	 *
	 * @param invest
	 *            总借款额（贷款本金）
	 * @param yearRate
	...
	/**
	 * 到期还本还息（按天计息） 应还利息 公式：应还利息=出借本金*年化收益÷365*融资天数，体验金是365天 注：体验金专用
	 * 
	 * @param invest
	 *            总借款额（贷款本金）
	 * @param yearRate
	...
	/**
	 * 到期还本还息（按天计息） 垫付利息 公式：垫付利息=本金+应还总利息=出借本金*（1*（年化收益÷360*融资天数））；
	 *
	 * @param invest
	 *            总借款额（贷款本金）
	 * @param yearRate
