...
public abstract class UploadFileUtils {
	 ...
	 * @throws Exception
	 */
	public static String upload4Stream(String fileName, String path, File file, String[] allowTypes, long maxFileSize) throws Exception {
		String state = "";
	 ...
	 * @throws Exception
	 */
	public static String upload4Stream(String fileName, String path, InputStream fs, String[] allowTypes, long maxFileSize) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static boolean upload4CopyFile(String fileName, String path, File file, String[] allowTypes, long maxFileSize) throws Exception {
		boolean success = false;
		if (validTypeByName(fileName, allowTypes)) {
