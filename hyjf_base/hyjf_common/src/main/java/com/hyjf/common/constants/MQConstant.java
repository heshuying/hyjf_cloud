...
public interface MQConstant {
	...
	String CERT_BORROW_STATUS_TAG = CERT_REPAIR_BORROW_STATUS + "||" + MQConstant.ISSUE_INVESTING_TAG + "||" + MQConstant.ISSUE_INVESTED_TAG + "||" + MQConstant.LOAN_SUCCESS_TAG + "||" + MQConstant.REPAY_ALL_SUCCESS_TAG;

	/**转让项目*/
	String CERT_TRANSFER_PROJECT_GROUP = "CERT_TRANSFER_PROJECT_GROUP";
	String CERT_TRANSFER_PROJECT_TOPIC = "CERT_TRANSFER_PROJECT_TOPIC";
	String CERT_TRANSFER_PROJECT_TAG = "CERT_TRANSFER_PROJECT_TAG";
	/**转让状态*/
	String CERT_TRANSFER_STATUS_GROUP = "CERT_TRANSFER_STATUS_GROUP";
	String CERT_TRANSFER_STATUS_TOPIC = "CERT_TRANSFER_STATUS_TOPIC";
	String CERT_TRANSFER_STATUS_TAG = MQConstant.TRANSFER_SUCCESS_TAG+"||"+MQConstant.UNDERTAKE_ALL_FAIL_TAG+"||"+MQConstant.UNDERTAKE_ALL_SUCCESS_TAG+"||"+MQConstant.REPAY_ALL_SUCCESS_TAG;
	/**交易流水*/
