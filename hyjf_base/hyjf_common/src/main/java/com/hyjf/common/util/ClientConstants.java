...
public class ClientConstants implements Serializable {
	 ...
	 * 交易密码
	 */
	public static final String SETPASSWORD_ACTION = "/hyjf-app/bank/user/transpassword/setPassword";
	public static final String RESETPASSWORD_ACTION = "/hyjf-app/bank/user/transpassword/resetPassword";
