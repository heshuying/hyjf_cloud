...
public class DebtFreeze implements Serializable {
    private Integer id;
    ...
    private String unfreezeOrderDate;
    ...
    public void setUnfreezeOrderId(String unfreezeOrderId) {
        this.unfreezeOrderId = unfreezeOrderId == null ? null : unfreezeOrderId.trim();
    }

    public String getUnfreezeOrderDate() {
        return unfreezeOrderDate;
    }

    public void setUnfreezeOrderDate(String unfreezeOrderDate) {
        this.unfreezeOrderDate = unfreezeOrderDate == null ? null : unfreezeOrderDate.trim();
    }
