 ...
 */
@Service
public class ProtocolTemplateAdminServiceImpl implements ProtocolTemplateAdminService {

    @Autowired
    protected  ProtocolTemplateMapper protocolTemplateMapper;

    @Autowired
    protected ProtocolTemplateAdminCustomizeMapper protocolTemplateCustomizeMapper;
