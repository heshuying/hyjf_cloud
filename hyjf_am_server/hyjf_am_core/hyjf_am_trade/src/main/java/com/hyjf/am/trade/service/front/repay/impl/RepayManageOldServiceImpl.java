 ...
 */
@Service
public class RepayManageOldServiceImpl extends BaseServiceImpl implements RepayManageOldService {
    private static final Logger logger = LoggerFactory.getLogger(RepayManageOldServiceImpl.class);
