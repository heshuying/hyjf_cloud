    ...
    public JSONObject getBorrowCoupon(MyCouponListRequest requestBean) {
        ...
        for (MyCouponListCustomizeVO bestCoupon : list) {
            ...
            if("1".equals(tenderQuota)){
                if((null == bestCoupon.getTenderQuotaMin() && null == bestCoupon.getTenderQuotaMax()) || bestCoupon.getTenderQuotaMin()> new Double(money)||bestCoupon.getTenderQuotaMax()<new Double(money)){
