...
/**
 * @author xiasq
 * @version TransactionProducerD, v0.1 2018/6/26 10:29
 */
public class TransactionProducerD {
	private static int threadCount = 32;
	private static int messageSize = 1024 * 2;
	private static boolean ischeck = Boolean.TRUE;
	private static boolean ischeckffalse = Boolean.FALSE;
	...
	public static void main(String[] args) throws MQClientException, UnsupportedEncodingException {
		...
		final TransactionCheckListener transactionCheckListener = new TransactionCheckListenerBImpl(ischeckffalse,
				statsBenchmark);
...
class StatsBenchmarkTProducer {
	...
	public Long[] createSnapshot() {
		Long[] snap = new Long[] { System.currentTimeMillis(), this.sendRequestSuccessCount.get(),
				...
				this.receiveResponseFailedCount.get(), this.sendMessageSuccessTimeTotal.get(),
