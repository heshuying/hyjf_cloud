 ...
 */
public class CertReportEntityVO implements Serializable {
     ...
     * @param dataList
     */
    public CertReportEntityVO(String remark, String infType, JSONArray dataList) {
        super();
     ...
     * @param dataList
     */
    public CertReportEntityVO(String remark, String infType, String logParm, JSONArray dataList) {
        super();
        this.dataList = dataList;
        this.remark = remark;
        this.infType = infType;
