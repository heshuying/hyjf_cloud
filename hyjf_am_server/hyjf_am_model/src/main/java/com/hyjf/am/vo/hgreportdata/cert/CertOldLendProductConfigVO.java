...
public class CertOldLendProductConfigVO implements Serializable {
    ...
    public CertOldLendProductConfigVO() {
        super();
    }
     ...
     * @param dataList
     */
    public CertOldLendProductConfigVO(String remark, String infType, JSONArray dataList) {
        super();
     ...
     * @param dataList
     */
    public CertOldLendProductConfigVO(String remark, String infType, String logParm, JSONArray dataList) {
        super();
        this.dataList = dataList;
        this.remark = remark;
        this.infType = infType;
