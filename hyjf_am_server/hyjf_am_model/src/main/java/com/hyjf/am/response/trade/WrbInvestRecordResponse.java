...
/**
 * @author lisheng
 * @version WrbInvestRecordResponse, v0.1 2018/11/7 10:08
 */

public class WrbInvestRecordResponse extends WrbResponse {
    /** 平台用户id */
    private String pf_user_id;

    /** 投资记录 */
    private List<WrbInvestRecordVO> invest_records = new ArrayList<WrbInvestRecordVO>();
    ...
    public List<WrbInvestRecordVO> getInvest_records() {
        return invest_records;
    }

    public void setInvest_records(List<WrbInvestRecordVO> invest_records) {
        this.invest_records = invest_records;
    }

    /** 内部类 */
    public static final class WrbInvestRecord {
