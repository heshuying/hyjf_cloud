...
public class BorrowListVO  extends BaseVO implements Serializable {
	 ...
	 * 是否已经还完款
	 */
	private String repayFullStatus;
	/**
	 * 满标时间
	 */
	...
	public String getRepayFullStatus() {
        return repayFullStatus;
    }


    public void setRepayFullStatus(String repayFullStatus) {
