 ...
 * @version V1.0  
 */
public class BorrowCommonRequest extends BasePage implements Serializable {
	...
	public int getCompanyOrPersonal() {
	...
	public void setCompanyOrPersonal(int companyOrPersonal) {
