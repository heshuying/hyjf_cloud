...
public class ProjectRepayVO extends BaseVO implements Serializable {
    ...
    /** 用户还款详情 */
    private List<ProjectRepayDetailVO> userRepayDetailList;

    public ProjectRepayVO() {
        super();
    }
    ...
    public List<ProjectRepayDetailVO> getUserRepayDetailList() {
        return userRepayDetailList;
    }

    public void setUserRepayDetailList(List<ProjectRepayDetailVO> userRepayDetailList) {
