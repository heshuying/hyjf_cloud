...
public class UserHjhInvistDetailCustomizeVO extends BaseVO implements Serializable {
    ...
    public String getAccedeAccount() {
        DF_FOR_VIEW.setRoundingMode(RoundingMode.FLOOR);
        return DF_FOR_VIEW.format(new BigDecimal(accedeAccount));
    }
    ...
    public String getWaitTotal() {
    	DF_FOR_VIEW.setRoundingMode(RoundingMode.FLOOR);
        return DF_FOR_VIEW.format(new BigDecimal(waitTotal));
    }
    ...
    public String getWaitInterest() {
    	DF_FOR_VIEW.setRoundingMode(RoundingMode.FLOOR);
        return DF_FOR_VIEW.format(new BigDecimal(waitInterest));
    }
    ...
    public String getReceivedTotal() {
    	DF_FOR_VIEW.setRoundingMode(RoundingMode.FLOOR);
        return DF_FOR_VIEW.format(new BigDecimal(receivedTotal));
    }
    ...
    public String getReceivedInterest() {
    	DF_FOR_VIEW.setRoundingMode(RoundingMode.FLOOR);
        return DF_FOR_VIEW.format(new BigDecimal(receivedInterest));
    }
    ...
    public String getAllTotal() {
    	DF_FOR_VIEW.setRoundingMode(RoundingMode.FLOOR);
        return DF_FOR_VIEW.format(new BigDecimal(allTotal));
    }
    ...
    public String getAllInterest() {
    	DF_FOR_VIEW.setRoundingMode(RoundingMode.FLOOR);
        return DF_FOR_VIEW.format(new BigDecimal(allInterest));
    }
