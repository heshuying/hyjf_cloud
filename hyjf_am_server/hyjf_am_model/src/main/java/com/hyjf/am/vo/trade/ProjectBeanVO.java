...
public class ProjectBeanVO extends BaseVO implements Serializable {
	...
	private boolean blAllRepay;

	public boolean isBlAllRepay() {
		return blAllRepay;
	}

	public void setBlAllRepay(boolean blAllRepay) {
		this.blAllRepay = blAllRepay;
	}

	/** 用户还款详情 */
	private List<ProjectRepayVO> userRepayList;

	public ProjectBeanVO() {
		super();
	}
	...
	public List<ProjectRepayVO> getUserRepayList() {
		return userRepayList;
	}

	public void setUserRepayList(List<ProjectRepayVO> userRepayList) {
