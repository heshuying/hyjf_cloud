...
public class ImageUtil {
    ...
    public static void main(String[] args) {
        String output = "/Applications/work/Demo_Contract_Travel_img/";
        String source = "/Applications/work/Demo_Contract_Travel_img/Demo_Contract_Travel_img2.png";    //源图片路径
        String icon = "/Applications/work/image.png";  //覆盖图片路径
...
//        int size = 8;   //马赛克大小
        ...
        String result = null;
        //给图片添加图片水印
        result = ImageUtil.markImageByMoreIcon(icon,source,output,imageName,imageType,degree,772,332);
...
//        result = MarkImageUtils.markImageByMosaic(source,output,imageName,imageType,size);
     ...
     */
    public static String markImageByMoreIcon(String icon,String source,String output,String imageName,String imageType,Integer degree,Integer index_x,Integer index_y) {
        ...
        try {
            ...
            for(int i=0;i<space;i++){
                ...
                g.drawImage(con, index_x , index_y, null);
