...
public class ContentLinksController extends BaseController {
    ...
    @ApiOperation(value = "内容中心-友情链接", notes = "内容中心-友情链接列表查询")
    ...
    @ApiOperation(value = "内容中心-友情链接", notes = "添加内容中心-友情链接")
    ...
    @ApiOperation(value = "内容中心-友情链接", notes = "修改内容中心-友情链接")
    ...
    @ApiOperation(value = "内容中心-友情链接", notes = "修改内容中心-友情链接状态")
    ...
    @ApiOperation(value = "内容中心-友情链接", notes = "删除内容中心-友情链接")
