...
public class CertificateAuthorityExceptionClientImpl implements CertificateAuthorityExceptionClient{
	...
	public CertificateAuthorityResponse getRecordList(CertificateAuthorityRequest aprlr) {
	    ...
	    CertificateAuthorityResponse response = restTemplate.postForEntity(url,aprlr,CertificateAuthorityResponse.class).getBody();
        if (response != null) {
            return response;
        }
        return null;
	...
	public CertificateAuthorityResponse updateUserCAMQ(int userId) {
	    ...
	    CertificateAuthorityResponse response = restTemplate.postForEntity(url,userId,CertificateAuthorityResponse.class).getBody();
        if (response != null) {
            return response;
        }
        return null;
