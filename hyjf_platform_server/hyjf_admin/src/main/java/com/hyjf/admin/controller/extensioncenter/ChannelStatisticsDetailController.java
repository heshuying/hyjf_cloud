...
public class ChannelStatisticsDetailController extends BaseController {
    ...
    public AdminResult searchAction(@RequestBody ChannelStatisticsDetailRequest channelStatisticsDetailRequest, HttpServletRequest request) {
        ...
        if(user!=null&&StringUtils.isNotEmpty(user.getId())){
             adminUtmReadPermissions = this.channelStatisticsDetailService.selectAdminUtmReadPermissions(Integer.valueOf(user.getId()));
        }
    ...
    public void exportAction(HttpServletResponse response, @RequestBody ChannelStatisticsDetailRequest form) throws Exception {
        // 表格sheet名称
