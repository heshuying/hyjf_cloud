...
public class EmailRecipientController {
    ...
    public AdminResult insertAction(@RequestBody EmailRecipientRequest recipientRequest) {
        AdminResult result = new AdminResult();
        result.setStatus(emailRecipientService.insertAction(recipientRequest).getRtn());
        return result;
    }
    ...
    public AdminResult updateAction(@RequestBody EmailRecipientRequest recipientRequest) {
        AdminResult result = new AdminResult();
        result.setStatus(emailRecipientService.updateEmailRecipient(recipientRequest).getRtn());
        return result;
    }

    @ApiOperation(value = "收件人邮件配置禁用和启用", notes = "收件人邮件配置禁用和启用")
    @PostMapping("/forbiddenAction")
    public AdminResult forbiddenAction(@RequestBody EmailRecipientRequest recipientRequest) {
        AdminResult result = new AdminResult();
        result.setStatus(emailRecipientService.forbiddenAction(recipientRequest).getRtn());
        return result;
    }
