 ...
 */
package com.hyjf.cs.trade.mq.producer.sensorsdate.auth;
 ...
 *
 * @author liuyang
 * @version SensorsDataAuthProducer, v0.1 2018/10/25 10:02
 */
@Component
public class SensorsDataAuthProducer extends Producer {
    @Override
    protected ProducerFieldsWrapper getFieldsWrapper() {
        ProducerFieldsWrapper wrapper = new ProducerFieldsWrapper();
        wrapper.setGroup(MQConstant.SENSORSDATA_AUTH_GROUP);
