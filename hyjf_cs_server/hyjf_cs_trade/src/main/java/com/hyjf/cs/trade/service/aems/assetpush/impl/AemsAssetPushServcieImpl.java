 ...
 **/
@Service
public class AemsAssetPushServcieImpl extends BaseTradeServiceImpl implements AemsAssetPushService {

    private Logger logger = LoggerFactory.getLogger(AemsAssetPushServcieImpl.class);
