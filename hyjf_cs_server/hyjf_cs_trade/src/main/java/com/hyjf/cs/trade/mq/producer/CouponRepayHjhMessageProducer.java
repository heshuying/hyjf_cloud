 ...
 * @Description: CouponRepayHjhMessageProducer
 */
@Component
public class CouponRepayHjhMessageProducer extends Producer {
    @Override
    protected ProducerFieldsWrapper getFieldsWrapper() {
        ProducerFieldsWrapper wrapper = new ProducerFieldsWrapper();
        wrapper.setGroup(MQConstant.HJH_COUPON_REPAY_GROUP);
