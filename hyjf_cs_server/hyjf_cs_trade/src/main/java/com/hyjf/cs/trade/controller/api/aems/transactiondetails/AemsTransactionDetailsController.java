package com.hyjf.cs.trade.controller.api.aems.transactiondetails;
 ...
 * @return
 **/
@Api(value = "api端-AEMS交易明细查询",tags = "api端-AEMS交易明细查询")
@Controller
@RequestMapping(value = "/hyjf-api/aems/tradelist")
public class AemsTransactionDetailsController extends BaseController {

    @Autowired
    private AemsTransactionDetailsService transactionDetailsService;
    @Autowired
    ...
    public ResultApiBean srchTradeList(@RequestBody AemsTransactionDetailsResultBean resultBean){
        ...
        // 验签
        CheckUtil.check(SignUtil.AEMSVerifyRequestSign(resultBean, "/aems/tradelist/tradelist"),MsgEnum.ERR_SIGN);
        // 返回查询结果
