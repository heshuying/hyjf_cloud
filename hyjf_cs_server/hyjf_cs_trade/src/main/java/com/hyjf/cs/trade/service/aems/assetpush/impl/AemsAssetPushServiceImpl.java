...
public class AemsAssetPushServiceImpl extends BaseTradeServiceImpl implements AemsAssetPushService {
    ...
    public AemsPushResultBean assetPush(AemsPushRequestBean pushRequestBean) {
        ...
        for (AemsPushBean pushBean : pushRequestBean.getReqData()) {
            try {
                // 资产推送公用方法 0:个人 1:企业
        ...
        return assembleResult(new AemsPushResultBean(), retAssets, pushRequestBean.getRiskInfo(), 0);
    }
    ...
    public AemsPushResultBean companyAssetPush(AemsPushRequestBean pushRequestBean) {
        ...
        // 资产推送 参数校验
        AemsPushResultBean resultBean = checkParam(pushRequestBean, assetBorrow, instCode, 1);
        if (resultBean != null){
            return resultBean;
        }
        ...
        return assembleResult(new AemsPushResultBean(), retAssets, pushRequestBean.getRiskInfo(), 1);
    }
     ...
     * @return
     */
    public AemsPushResultBean checkParam(AemsPushRequestBean pushRequestBean, HjhAssetBorrowTypeVO assetBorrow, String instCode, int identityFlag){
        String logFlag = null;
     ...
     * @return
     */
    public AemsPushBean commonProcessCompanyAsset(AemsPushBean pushBean, String instCode, Integer assetType,
        ...
        if (StringUtils.isBlank(pushBean.getAssetId())){
            logger.warn(logFlag+"资产推送[资产编号不能为空!]");
        ...
        if(identityFlag == 0){
            ...
            // 借款用途 不能为空
            if(org.apache.commons.lang.StringUtils.isEmpty(pushBean.getUseage())){
     ...
     * @return
     */
    private AemsPushResultBean assembleResult(AemsPushResultBean resultBean, List<AemsPushBean> retAssets,
     ...
     * @return
     */
    private boolean checkPersonPushInfo(AemsPushBean pushBean) {
