 ...
 */
@Service
public class BaseHgCertReportServiceImpl extends BaseServiceImpl implements BaseHgCertReportService {
     ...
     */
    @Override
    public CertReportEntity insertAndSendPost(CertReportEntity bean) {
        try {
            // 设置共通参数
     ...
     * @return
     */
    protected Map<String, String> getBankParam(CertReportEntity bean){
        // 组装调用接口需要的参数对象
     ...
     * @return
     */
    protected CertReportEntity setResult(CertReportEntity bean, String rtnMsg) {
     ...
     * @param bean
     */
    private void insertCertLog(CertLog certLog, CertReportEntity bean) {
     ...
     * @return
     */
    protected CertReportEntity setCommonParam(CertReportEntity bean) throws Exception {
     ...
     */
    @Override
    public BankCard getBankCardById(Integer userId) {
     ...
     */
    @Override
    public CertUser getCertUserByUserId(Integer userId) {
     ...
     */
    @Override
    public CertUser getCertUserByUserIdcardHash(String userIdcardHash) {
        CertUserExample example = new CertUserExample();
        CertUserExample.Criteria cra = example.createCriteria();
     ...
     * @return
     */
    protected CertUser getCertUserByUserIdBorrowNid(Integer userId, String borrowNid) {
        CertUserExample example = new CertUserExample();
        CertUserExample.Criteria cra = example.createCriteria();
        cra.andUserIdEqualTo(userId);
        cra.andBorrowNidEqualTo(borrowNid);
     ...
     * @throws Exception
     */
    protected String getUserHashValue(Borrow borrow) throws Exception {
        String userIdcard = "";
        if (borrow != null) {
     ...
     */
    @Override
    public List<CertUser> getCertUsersByUserId(int userId) {
        CertUserExample example = new CertUserExample();
        CertUserExample.Criteria cra = example.createCriteria();
        cra.andUserIdEqualTo(userId);
        List<CertUser> list = certUserMapper.selectByExample(example);
