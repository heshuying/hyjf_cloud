...
/**
 * @author xiasq
 * @version WechatActivity518Controller, v0.1 2019-04-17 9:48
 */
@Api(tags = "wechat端-2019-518活动")
@RestController
@RequestMapping("/hyjf-wechat/activity/2019518")
public class WechatActivity518Controller extends AbstractActivity518Controller {
    private Logger logger = LoggerFactory.getLogger(WechatActivity518Controller.class);
    ...
    public BaseResult<Activity518DrawVO> draw(@RequestHeader Integer userId) {
        logger.info("wechat端-抽奖, userId is: {}", userId);
