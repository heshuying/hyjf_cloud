...
public class HomePageController extends BaseMarketController {
    ...
    public JSONObject getStartPage(@RequestHeader(value = "platform", required = false) String platform,
        ...
        logger.info(this.getClass().getName(), "获取起始页广告信息 start", "platform：{}"+ platform + ",realPlatform：{}"+ realPlatform,
                "/hyjf-app/homepage/getStartPage");
        ...
        try {
            ...
            logger.info(this.getClass().getName(), "获取起始页广告信息 异常", "/hyjf-app/homepage/getStartPage",
                    e);
            result.put(CustomConstants.APP_STATUS, CustomConstants.APP_STATUS_FAIL);
