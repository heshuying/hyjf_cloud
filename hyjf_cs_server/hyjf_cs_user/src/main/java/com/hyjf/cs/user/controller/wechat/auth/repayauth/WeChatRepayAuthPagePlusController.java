...
public class WeChatRepayAuthPagePlusController extends BaseUserController {
    ...
    public  WebResult<Object> page(@RequestHeader(value = "wjtClient",required = false) String wjtClient,
        ...
        // 同步地址  是否跳转到前端页面
        String retUrl = host + errorPath +"?logOrdId="+orderId+"&authType="+AuthBean.AUTH_TYPE_REPAY_AUTH;
        String successUrl = host + successPath+"?logOrdId="+orderId+"&authType="+AuthBean.AUTH_TYPE_REPAY_AUTH;
