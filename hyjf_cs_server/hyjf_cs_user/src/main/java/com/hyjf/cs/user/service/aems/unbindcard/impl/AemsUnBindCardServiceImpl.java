package com.hyjf.cs.user.service.aems.unbindcard.impl;
 ...
 **/
@Service
public class AemsUnBindCardServiceImpl extends BaseUserServiceImpl implements AemsUnBindCardService {
	private static final Logger logger = LoggerFactory.getLogger(AemsUnBindCardServiceImpl.class);
	@Autowired
