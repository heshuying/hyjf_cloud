 ...
 */
package com.hyjf.cs.user.controller.wechat.auth.mergeauth;
...
@CrossOrigin(origins = "*")
@RestController
@RequestMapping("/hyjf-wechat/bank/user/auth/mergeauthpageplus")
public class WeChatMergeAuthPagePlusController extends BaseUserController {

    private static final Logger logger = LoggerFactory.getLogger(WeChatMergeAuthPagePlusController.class);
