...
public enum ResultEnum {
    ...
    ERROR_013("013","密码长度6-16位"),
    ERROR_014("014","密码必须包含数字"),
    ERROR_015("015","密码必须由数字和字母组成，如abc123"),
    ...
    USER_ERROR_202("202", "用户自动投资已授权,无需重复授权"),
    USER_ERROR_203("203", "用户自动债转已授权,无需重复授权"),
    USER_ERROR_204("204", "用户自动投资授权失败"),
    ...
    USER_ERROR_213("213", "为更好保障您的投资利益，您须在完成风险测评后才可进行投资"),
