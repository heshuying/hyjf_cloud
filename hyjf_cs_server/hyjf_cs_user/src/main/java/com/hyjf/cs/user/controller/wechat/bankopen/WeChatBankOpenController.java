...
public class WeChatBankOpenController extends BaseUserController {
    ...
    @ResponseBody
    public WeChatResult openBankAccount(@RequestHeader(value = "wjtClient",required = false) String wjtClient,@RequestHeader(value = "userId") Integer userId,  @RequestHeader(value = "sign") String sign,@RequestBody @Valid BankOpenVO bankOpenVO, HttpServletRequest request) {
