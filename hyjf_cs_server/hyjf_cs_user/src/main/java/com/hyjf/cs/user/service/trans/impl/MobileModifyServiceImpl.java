...
public class MobileModifyServiceImpl extends BaseUserServiceImpl implements MobileModifyService {
	...
	public boolean checkForMobileModifyOpened(String newMobile, String smsCode, String srvAuthCode) {
        CheckUtil.check(!StringUtils.isBlank(newMobile), MsgEnum.ERR_PARAM_TYPE);
        CheckUtil.check(!StringUtils.isBlank(smsCode), MsgEnum.ERR_PARAM_TYPE);
        CheckUtil.check(!StringUtils.isBlank(srvAuthCode), MsgEnum.ERR_PARAM_TYPE);
        return true;
    }
