 ...
 */
package com.hyjf.cs.user.service.aems.synbalance.impl;
 ...
 */
@Service
public class AemsSynBalanceServiceImpl extends BaseUserServiceImpl implements AemsSynBalanceService {
    ...
    @Override
    public AemsSynBalanceResultBean synBalance(AemsSynBalanceRequestBean synBalanceRequestBean, String ip) {
        AemsSynBalanceResultBean resultBean = new AemsSynBalanceResultBean();
        //根据账号找出用户ID
    ...
    private BankOpenAccountVO getBankOpenAccount(String accountId) {
    ...
    * @param userId
    * @return com.hyjf.am.vo.trade.account.AccountVO
    **/
    private AccountVO getAccount(Integer userId) {
     ...
     */
    @Deprecated
    private BankCallBean queryAccountDetails(Integer userId, String accountId, String startDate, String endDate, String type, String transType, String pageNum, String pageSize, String inpDate, String inpTime, String relDate, String traceNo) {
        // 参数不正确
    ...
    public BankCallBean queryAccountDetailsNew(Integer userId, String accountId, String startDate, String endDate, String transType, String pageNum, String inpDate, String inpTime, String relDate, String traceNo) {
        ...
        // 订单时间
        bean.setLogOrderDate(GetOrderIdUtils.getOrderDate());
        bean.setLogRemark("Aems线下充值明细查询");
        bean.setLogUserId(String.valueOf(userId));
        // 调用接口
        return BankCallUtils.callApiBg(bean);
    }
     ...
     * @return
     */
    private List<UnderLineRechargeVO> selectUnderLineRechargeList(UnderLineRechargeRequest request){
    ...
    private boolean insertAccountDetails(AccountVO accountUser, SynBalanceVO synBalanceBean, UserVO user, String ipAddr) {
