 ...
 */
package com.hyjf.cs.user.controller.wechat.auth.invesauth;
...
@CrossOrigin(origins = "*")
@RestController
@RequestMapping("/hyjf-wechat/bank/user/auth/invesauthpageplus")
public class WeChatInvesAuthPagePlusController extends BaseUserController {

    private static final Logger logger = LoggerFactory.getLogger(WeChatInvesAuthPagePlusController.class);
    ...
    public  WebResult<Object> page(@RequestHeader(value = "wjtClient",required = false) String wjtClient,
        ...
        // 同步地址  是否跳转到前端页面
        String retUrl = host + errorPath +"?logOrdId="+orderId+"&authType="+AuthBean.AUTH_TYPE_AUTO_BID;
        String successUrl = host + successPath+"?logOrdId="+orderId+"&authType="+AuthBean.AUTH_TYPE_AUTO_BID;
