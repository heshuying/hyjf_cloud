 ...
 * 运营报告
 * @author tanyy
 * @version OperationColumnReport, v0.1 2018/7/23 16:20
 */
@Document(collection = "ht_operation_column_report")
public class OperationColumnReport implements Serializable {
