 ...
 * 预计资金计划
 * @author PC-LIUSHOUYI
 * @version HjhPlanCapitalPrediction, v0.1 2019/4/2 10:01
 */
@Document(collection = "ht_hjh_plan_capital_prediction")
public class HjhPlanCapitalPrediction  implements Serializable {
