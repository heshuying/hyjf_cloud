...
/**
 * //合规数据上报 CERT  国家互联网应急中心    交易明细
 *
 * @author sss
 * @version BaseHgDataReportEntity, v0.1 2018/6/27 10:06
 */
@Document(collection = "ht_cert_account_list")
public class CertAccountList implements Serializable {
     ...
     * @param dataList
     */
    public CertAccountList(String remark, String infType, JSONArray dataList) {
        super();
     ...
     * @param dataList
     */
    public CertAccountList(String remark, String infType, String logParm, JSONArray dataList) {
        super();
        this.dataList = dataList;
        this.remark = remark;
        this.infType = infType;
