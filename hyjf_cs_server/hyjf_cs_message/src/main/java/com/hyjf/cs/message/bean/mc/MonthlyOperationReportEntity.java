 ...
 * 月度运营报告
 * @author tanyy
 * @version MonthlyOperationReportEntity, v0.1 2018/6/27 10:01
 */
@Document(collection = "ht_monthly_operation_report")
public class MonthlyOperationReportEntity implements Serializable {
