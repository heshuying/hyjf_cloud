 ...
 * 月度运营报告
 * @author tanyy
 * @version OperationMonthlyReport, v0.1 2018/6/27 10:01
 */
@Document(collection = "ht_operation_monthly_report")
public class OperationMonthlyReport implements Serializable {
