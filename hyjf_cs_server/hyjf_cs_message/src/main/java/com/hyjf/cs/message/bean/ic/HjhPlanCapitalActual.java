 ...
 * 实际资金计划
 * @author PC-LIUSHOUYI
 * @version HjhPlanCapitalActual, v0.1 2019/4/2 10:02
 */
@Document(collection = "ht_hjh_plan_capital_actual")
public class HjhPlanCapitalActual  implements Serializable {
