 ...
 * 运营数据
 * @author jun
 * @version BifaOperationDataEntity, v0.1 2018/11/30 9:07
 */
@Document(collection = "ht_bifa_operationdata")
public class BifaOperationDataEntity extends BaseHgDataReportEntity implements Serializable {
